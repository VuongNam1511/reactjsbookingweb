...
import { savePulkScheduleDoctor } from '../../../services/userService';
...
class ManageSchedule extends Component {
    ...
    componentDidUpdate(prevPops, prevState, snapshot) {
        ...
        if (prevPops.allScheduleTime !== this.props.allScheduleTime) {
    ...
    handleSaveSchedule = async () => {
        ...
        let res = await savePulkScheduleDoctor({
            arrSchedule: result,
            doctorId: selectedDoctor.value,
            formatedDate: formatedDate
        })
        console.log('check result savePulkScheduleDoctor: ', res)
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            ...
                            >
                                <FormattedMessage id="manage-schedule.save-schedule-infor" />
