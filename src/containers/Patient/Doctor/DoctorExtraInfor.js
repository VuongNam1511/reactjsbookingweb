...
class DoctorExtraInfor extends Component {
    ...
    render() {
        ...
        console.log('check state from #81: ', this.state)
        return (
                    ...
                    {isShowDetailInfor === false &&
                        <div className='showMore'>
                            ...
                            {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.EN &&
                                <NumberFormat className='currency'
                                    value={extraInfor.priceTypeData.valueEn} displayType='text' thousandSeparator={true} prefix=' $'>
                                </NumberFormat>
                            }
                            <span onClick={() => this.ShowHideDetailInfor(true)}>
                                <FormattedMessage id="patient.extra-infor-doctor.show-more" />
                        ...
                        <>
                            ...
                            <div className='hide-price'>
                                <span onClick={() => this.ShowHideDetailInfor(false)}>
                                    <FormattedMessage id="patient.extra-infor-doctor.hidepayment" />
